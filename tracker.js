let jobs = [
  ...
  },
  {
    ...
    description: "Create responsive websites for high-profile clients.",
    status: "all",
  },
  {
    id: 3,
    ...
    description: "Transform complex data into interactive dashboards.",
    status: "all",
  },
  {
    id: 4,
    ...
    description: "Design APIs and manage modern cloud infrastructure.",
    status: "all",
  },
  {
    id: 5,
    ...
    description: "Design clean interfaces for scalable digital products.",
    status: "all",
  },
  {
    id: 6,
    ...
    description: "Develop modern web applications using JavaScript.",
    status: "all",
  },
  {
    id: 7,
    ...
    description: "Build scalable applications using modern tech stacks.",
    status: "all",
  },
  {
    id: 8,
    ...
    container.innerHTML += `
      <div class="bg-white p-6 rounded-xl shadow relative">
        ...
        <button onclick="deleteJob(${job.id})"
          class="absolute top-5 right-5 text-gray-400 hover:text-red-500 cursor-pointer">
       <i class="fa-regular fa-trash-can"></i>
        ...
        <div class="flex gap-4 mt-6">
          <button onclick="setStatus(${job.id}, 'interview')"
            class="px-5 py-2 border border-green-500 text-green-600 rounded-lg hover:bg-green-50 cursor-pointer">
            Interview
          </button>

          <button onclick="setStatus(${job.id}, 'rejected')"
            class="px-5 py-2 border border-red-500 text-red-600 rounded-lg hover:bg-red-50 cursor-pointer">
            Rejected
          </button>
        </div>
